...
# =============================================================================
NUM_ROBOTS = 2              # Número de robots en la simulación
NUM_MONSTERS = 3            # Número de monstruos en la simulación
...
MONSTER_FREQUENCY = 10       # Frecuencia del monstruo (cada K segundos)
MONSTER_PROBABILITY = 0.1   # Probabilidad de que el monstruo se mueva en cada turno (parámetro p)
